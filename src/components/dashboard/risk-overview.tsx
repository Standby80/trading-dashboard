    ...
    <Card className="bg-transparent border-transparent rounded-xl shadow-none h-full overflow-hidden flex flex-col">
      ...
      <CardContent className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-muted-foreground w-24">Max Drawdown</span>
            <div className="flex-1 mx-4 h-2 bg-muted rounded-full overflow-hidden">
                <div className="h-full bg-violet-500 rounded-full" style={{ width: `${ddWidth}%` }}></div>
            </div>
            <span className="text-xs font-medium text-foreground w-12 text-right">{ddPct.toFixed(2)}%</span>
        </div>

        {/* Sharpe Ratio */}
        <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-muted-foreground w-24">Sharpe Ratio</span>
            <div className="flex-1 mx-4 h-2 bg-muted rounded-full overflow-hidden">
                <div className="h-full bg-emerald-500 rounded-full" style={{ width: `${sharpeWidth}%` }}></div>
            </div>
            <span className="text-xs font-medium text-foreground w-12 text-right">{sharpe.toFixed(2)}</span>
        </div>

        {/* Profit Factor */}
        <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-muted-foreground w-24">Profit Factor</span>
            <div className="flex-1 mx-4 h-2 bg-muted rounded-full overflow-hidden">
        ...
        {/* Win Rate */}
        <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-muted-foreground w-24">Win Rate</span>
            <div className="flex-1 mx-4 h-2 bg-muted rounded-full overflow-hidden">
        ...
        <div className="flex items-center justify-between">
            <span className="text-xs text-muted-foreground w-24">Wins / Losses (R)</span>
