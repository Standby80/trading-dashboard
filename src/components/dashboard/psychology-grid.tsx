  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-white/5">
      ...
      <div className="bg-transparent p-6 flex flex-col justify-between relative overflow-hidden group hover:bg-white/[0.02] transition-colors">
        ...
        <div className="mt-auto">
          <div className="text-4xl font-bold text-white mb-2 tracking-tight">
            {kpis.revengeTradesCount} <span className="text-sm font-medium text-slate-500 ml-1 tracking-normal">trades</span>
          </div>
      ...
      <div className="bg-transparent p-6 flex flex-col justify-between relative overflow-hidden group hover:bg-white/[0.02] transition-colors">
        ...
        <div className="mt-auto">
          <div className="text-4xl font-bold text-white mb-2 tracking-tight">
            {kpis.overtradingDaysCount} <span className="text-sm font-medium text-slate-500 ml-1 tracking-normal">days</span>
          </div>
          <div className="text-xs text-slate-400 flex items-center gap-1.5 font-medium">
      ...
      <div className="bg-transparent p-6 flex flex-col justify-between hover:bg-white/[0.02] transition-colors">
        ...
        <div className="flex flex-col gap-3 mt-auto">
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400">Max Wins (Count)</span>
          ...
          <div className="flex items-center justify-between pt-1">
            <span className="text-xs text-slate-400">Max Losses (Count)</span>
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400">Max Losses (PNL)</span>
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400">Avg Lose Streak</span>
            <span className="text-sm font-bold text-slate-200">{kpis.avgLoseStreakCount || 0}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-transparent p-6 flex flex-col justify-between hover:bg-white/[0.02] transition-colors">
        ...
        <div className="flex flex-col gap-4 mt-auto">
          <div className="flex flex-col gap-3 pb-4 border-b border-white/5">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs text-slate-400">Largest Loss</span>
              <div className="text-right">
          ...
          <div className="flex flex-col gap-3 pt-1">
            <div className="flex items-center justify-between">
              <span className="text-xs text-slate-400">Average Win</span>
              <span className="text-[15px] font-bold text-emerald-400">{formatCurrency(kpis.avgWin)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-xs text-slate-400">Average Loss</span>
